...
public class T3 {
    ...
    Thread.sleep(2000);
    WebElement receivedDocuments = Driver.getDriver().findElement(By.xpath("//h2[contains(., 'Received') and contains(., 'documents')]"));
    ...
    WebElement inProgressStatus = Driver.getDriver().findElement(By.xpath("//div[@class='v-list-item__title' and text()='In progress']"));
    inProgressStatus.click();
    actual = Driver.getDriver().findElement(By.xpath("//div[@class='v-select__selection v-select__selection--comma']")).getText();
